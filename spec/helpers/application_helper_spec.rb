...
RSpec.describe ApplicationHelper, type: :helper do
  ...
  it 'filter items returns correct checkbox tag' do
  ...
  it 'upload_icon returns correct icon' do
    expect(helper.upload_icon('application/msword')).to eq tag.i class: 'fa-regular fa-2x fa-file-word'
    expect(helper.upload_icon('application/xls')).to eq tag.i class: 'fa-regular fa-2x fa-file-excel'
    expect(helper.upload_icon('application/pdf')).to eq tag.i class: 'fa-regular fa-2x fa-file-pdf'
    expect(helper.upload_icon('application/vnd.ms-powerpoint')).to eq tag.i class: 'fa-regular fa-2x fa-file-powerpoint'
    expect(helper.upload_icon('text/csv')).to eq tag.i class: 'fa-regular fa-2x fa-file-csv'
    expect(helper.upload_icon('application/octet-stream')).to eq tag.i class: 'fa-regular fa-2x fa-cube'
    expect(helper.upload_icon('')).to eq tag.i class: 'fa-regular fa-2x fa-file'
  end

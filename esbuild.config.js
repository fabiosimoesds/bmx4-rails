...
const clients = []
const entryPoints = ['application.js', 'sentry.js']
...
const config = {
  ...
  minify: ['production', 'staging'].includes(process.env.RAILS_ENV),
  outdir: path.join(process.cwd(), 'app/assets/builds'),
  plugins: [rails()],
  sourcemap: !['production', 'staging'].includes(process.env.RAILS_ENV),
}

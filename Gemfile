...
# A utility library for enabling functionallity like loginning in for admins [https://github.com/oivoodoo/devise_masquerade]
...
group :development do
  ...
  gem 'spring'
  # Add a comment summarising the current schema to the top of each model [https://github.com/ctran/annotate_models]
  gem 'annotate'
